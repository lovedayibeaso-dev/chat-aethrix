    ...
    <div className="min-h-screen bg-background bg-grid flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="p-8 rounded-lg border border-border/50 bg-card/80 glow-green">
          <h2 className="text-xl font-bold text-foreground mb-1 font-mono">Create Account</h2>
          <p className="text-sm text-muted-foreground mb-6">Join and uncover hidden knowledge.</p>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Already have access?{" "}
            <Link to="/login" className="text-primary hover:underline font-mono">Log in</Link>
          </p>
        </div>
      </div>
    </div>
